...
class PreVerhistoricosClass(View):
	...
	def get(self, request, id):
		...
		datos = ResultadoBusqueda.objects.raw('SELECT  fecha_modificacion, MAX(id), id FROM hello_resultadobusqueda where busqueda_id = {} GROUP BY fecha_modificacion'.format(id))
		for i in datos:
